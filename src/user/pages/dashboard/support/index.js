  ...
  return (
    <>
      <Label
        ...
        classes={{
          root: `text-ideeza-100 font-bold text-xl tracking-tight pb-3`,
        }}
      />
      <div className="my-2 w-full">
        <TabsMolecule
          tabsClasses="border-b pb-4 mb-4 grid lg:grid-cols-2 grid-col-1 md:pr-16"
          tabClasses="bg-white rounded-md text-base tracking-tight mr-4 text-gray-300 font-sans transform-none shadow-md"
          ...
          tabsData={[
            {
              name: (
                <Icon_Label
                  ...
                  iconComponent={<GoMail className="text-gray-810 text-5xl" />}
