...
function General() {
  ...
  return (
    <form
      ...
      className="lg:w-8/12 xl:w-7/12 w-full pt-3 space-y-10 flex flex-col items-center"
    >
      <div className="w-full">
        <Label
          classes={{
            root:
              "text-current pb-1 text-xl font-sans font-bold tracking-tight w-full",
          }}
          value="Select your business status."
        />
        <RadioLabel
          mainClass="flex items-center -ml-2.5 -mt-2"
          onClick={showCompany}
          id="company"
          name="Company"
          value="Company"
        ...
        <div className="w-full space-y-8">
          <div className="w-full">
            <Label
              classes={{
                root:
                  "text-gray-300 tracking-normal pb-1 text-xl lg:text-2xl font-sans font-bold w-full",
              }}
            ...
            <Label
              classes={{
                root:
                  "text-current border-b border-gray-750 tracking-tight pb-1 mb-5 text-lg font-sans font-bold flex justify-between items-center w-full",
              }}
              value={
                <>
                  Edit General Profile Informations
            ...
            />
            <EditCompanyInformation useform={methods} />
          </div>
          <div className="w-full">
            <Label
              classes={{
          ...
          <div className="w-full">
            <Label
              classes={{
                root:
                  "text-current border-b border-gray-750 pb-1 mb-5 text-lg font-sans font-bold flex justify-between items-center w-full",
              }}
      ...
      <div className="w-full">
        <Label
          classes={{
            root:
              "text-current border-b border-gray-750 tracking-tight pb-1 mb-5 text-lg font-sans font-bold w-full",
          }}
          value="Hourly Rate"
        />
        <HourlyRates />
