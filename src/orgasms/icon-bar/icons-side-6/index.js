        ...
        icons={
          <>
            <div className="w-8 p-1.5 hover:bg-ideeza-460 rounded-sm cursor-pointer">
              <img
                src="/assets/images/cover/69.png"
              ...
              icons={
                <div className="flex flex-col items-end">
                  <div className="w-8 p-1.5 mr-2 hover:bg-ideeza-460 rounded-sm cursor-pointer">
                    <img
                      src="/assets/images/cover/71.png"
            ...
            <div className="w-8 p-1.5 hover:bg-ideeza-460 rounded-sm cursor-pointer">
              <img
                src="/assets/images/cover/74.png"
                className="w-100"
                alt="action"
              />
            </div>
            <Dropdown
              ...
              itemsClasses={{
                root:
                  "font-sans text-sm tracking-tight font-sans hover:text-current text-gray-880",
              }}
              options={[
                {
                  name: `Ctrl+V`,
            ...
            >
              <img
                src="/assets/images/cover/72.png"
                className="w-100 cursor-pointer"
                alt="action"
              />
            </div>
            <div className="w-8 p-1.5 hover:bg-ideeza-460 rounded-sm cursor-pointer">
              <img
                src="/assets/images/cover/75.png"
                className="w-100 cursor-pointer"
                alt="action"
              />
            </div>
            <div className="w-8 p-1.5 hover:bg-ideeza-460 rounded-sm cursor-pointer">
              <img
                src="/assets/images/cover/70.png"
                className="w-100 cursor-pointer"
                alt="action"
              />
            </div>
            <div className="w-8 p-1.5 hover:bg-ideeza-460 rounded-sm cursor-pointer">
              <img
                src="/assets/images/cover/73.png"
                className="w-100 cursor-pointer"
                alt="action"
              />
            </div>
            <div className="w-8 p-1.5 hover:bg-ideeza-460 rounded-sm cursor-pointer">
              <img
                src="/assets/images/cover/76.png"
                className="w-100 cursor-pointer"
                alt="action"
              />
            </div>
