        ...
        icons={
          <>
            <div className="w-8 p-1.5 hover:bg-ideeza-460 rounded-sm cursor-pointer">
              <img
                src="/assets/images/cover/77.png"
            ...
            <div className="w-8 p-1.5 hover:bg-ideeza-460 rounded-sm cursor-pointer">
              <img
                src="/assets/images/cover/80.png"
                className="w-100 cursor-pointer"
                alt="action"
              />
            </div>
            <div className="w-8 p-1.5 hover:bg-ideeza-460 rounded-sm cursor-pointer">
              <img
                src="/assets/images/cover/78.png"
                className="w-100 cursor-pointer"
                alt="action"
              />
            </div>
            <div className="w-8 p-1.5 hover:bg-ideeza-460 rounded-sm cursor-pointer">
              <img
                src="/assets/images/cover/81.png"
                className="w-100 cursor-pointer"
                alt="action"
              />
            </div>
            <div className="w-8 p-1.5 hover:bg-ideeza-460 rounded-sm cursor-pointer">
              <img
                src="/assets/images/cover/79.png"
                className="w-100 cursor-pointer"
                alt="action"
              />
            </div>
            <div className="w-8 p-1.5 hover:bg-ideeza-460 rounded-sm cursor-pointer">
              <img
                src="/assets/images/cover/82.png"
                className="w-100 cursor-pointer"
                alt="action"
              />
            </div>
